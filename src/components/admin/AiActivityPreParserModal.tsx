...
const DEMO_ACTIVITY_PROPOSALS = [
  {
    ...
    type: 'Word (.docx)',
    tag: '文化 · 研学 · 专车大巴 · L3跨省',
    content: `【乐龄慢游研学】苏州古典园林与吴门文脉5日深度学术慢游方案（草案）
...
【乐龄保障与体能】
全线乐龄舒缓慢行，每日步数严格控制在 4,200 步以内。全程安排无障碍电梯，配备随团医护与急救包（含AED）。入住苏州五星园林度假酒店，房间加装防滑扶手与温热卫洗丽。

【行程简述】
D1：各地上车专车抵达苏州，入住五星园林酒店。下午举行【同伴品茗破冰雅集】，顾教授主讲《吴门风雅溯源》。晚餐：松鹤楼苏帮迎宾宴。
D2：清晨避开人流专享入园【拙政园】，顾教授现场深度导赏叠山理水巧思。下午漫步【忠王府古戏台】，私享昆曲《牡丹亭》名票折子戏。晚餐：得月楼经典午宴。
...
D2：乘乐龄动车头等软座赴张掖，漫步张掖七彩丹霞，傍晚品尝河西养生排骨。
D3：参观天下第一雄关【嘉峪关】，听长城历史专家开讲《明代边防文脉》。
D4：抵达敦煌，入住敦煌山庄五星客栈。下午游览鸣沙山月牙泉（专备乐龄轻便观光车）。
...
随团专家：
浙江中医药大学退休教授、新安医学传人 汪明德 资深中医随团，每日早晚提供把脉问诊、经络八段锦传授与节气药膳调理。
...
D2：晨练八段锦，乘乐龄游船漫游千岛湖中心湖区，享用淳安有机鱼头无盐清炖药膳。
...
- 全员同伴参与纪念礼：黄山特产精美伴手礼盒 + 定制纪念徽章 + 500名仕积分

【执裁专家团队】
国家一级棋牌裁判员、全国智运会资深仲裁主任 严裁判长 亲临执裁，严守公平、友谊第一、乐龄文明原则。

【乐龄赛程与医疗急救保障】
- 赛场配备 2 台专业 AED 除颤仪与 2 名三甲医院退休随队红十字医护人员；
- 赛前提供免费血压心率筛查与健康档案登记；
- 赛场全场采用人体工学加厚护腰静音软椅，设温热养生草本茶饮站（罗汉果润喉茶/枸杞菊花茶）；
- 严格执行乐龄慢节奏赛程：每日对弈时长控制在2.5小时内，每轮设置20分钟颈椎放松操与中场茶歇；半天比赛 + 半天黄山温泉理疗慢游。

【赛程安排】
D1：下午抵达成团报到，办理五星温泉房入住，领取秩序册，晚间举行知青同伴破冰晚宴。
D2：开幕式及瑞士移位制预选赛第1~4轮（上午2轮，下午2轮，中场养生茶歇）。
D3：半决赛与巅峰总决赛对弈；下午安排黄山脚下温泉慢调水疗与同伴茶话会。
...
随团名家导师：
杨氏太极第六代正宗传人、国家级武术裁判 郑姓名师 现场点评与指导。
...
export const AiActivityPreParserModal: React.FC<AiActivityPreParserModalProps> = ({
  ...
  const handleStartAiParse = async () => {
    ...
    const stepTimer2 = setTimeout(() => {
      ...
      setParseStepText(
        targetType === 'event'
          ? '正在提取赛事执裁团队、乐龄赛程节奏、AED急救医疗守护与健康文娱表彰...'
          : '正在提取随团名师学者、每日步数负荷、乐龄五星住宿与发班规律...'
      );
    }, 900);
